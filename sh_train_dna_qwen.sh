...
CACHE_DIR='/lfs/ampere1/0/avgupta/hf_cache/'                   # Change to your HuggingFace cache directory
OUTPUT_DIR='/lfs/ampere1/0/avgupta/BioReason/logs/'               # Change to your output/log directory
WANDB_PROJECT=bioreason-kegg             # Change to your W&B project name
...
CUDA_VISIBLE_DEVICES=5 python train_dna_qwen.py \
     --cache_dir $CACHE_DIR \
     --wandb_project $WANDB_PROJECT \
     --text_model_name Qwen/Qwen3-1.7B \
     --dna_model_name InstaDeepAI/nucleotide-transformer-v2-500m-multi-species \
